...
namespace CoreAndFood.Controllers
{
    ...
    public class ChartController : Controller
    {
        ...
        public IActionResult Statistics()
        {
            ...
            var deger3 = c.Foods.Where(x=> x.CategoryID==FoodId).Count();
            ViewBag.d3 = deger3;
            ...
            var deger10 = c.Categories.Where(x => x.CategoryName == "Fruit").Select(y =>
            y.CategoryID).FirstOrDefault();
            var deger10p = c.Foods.Where(y => y.CategoryID == deger10).Sum(x => x.Stock);
            ViewBag.d10 = deger10p;
            
            var deger11 = c.Categories.Where(x => x.CategoryName == "Vegetables").Select(y =>
            y.CategoryID).FirstOrDefault();
